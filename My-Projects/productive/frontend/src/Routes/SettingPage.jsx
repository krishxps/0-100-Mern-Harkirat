  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-[#171111] text-white">
      ...
      <div className="flex flex-col items-center gap-4">
        <ActionButton text="Save" bgColor="bg-[#df2020]" additionalText="or press Space to start" />
        <ActionButton text="Go Back" bgColor="bg-transparent" borderColor="border border-white" />
      </div>
    </div>
  );
};
